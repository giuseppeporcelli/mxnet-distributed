...
parser.add_argument('--batch-size', type=int, default=os.environ['SM_HP_BATCH-SIZE'],
...
parser.add_argument('--model', type=str, required=True, default=os.environ['SM_HP_MODEL'],
...
parser.add_argument('--kvstore', type=str, default=os.environ['SM_HP_KVSTORE'], 
...
context = [mx.gpu(int(i)) for i in range(int(opt.gpus))] if opt.gpus else [mx.cpu()]
